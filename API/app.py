...
def compare_images():
    img_path = "C:\\Users\\charan sai\\Documents\\semesters\\Sem - 8\\NLP\\PostMidSem\\API\\Images\\temp_sign.png"
    image2_path = "C:\\Users\\charan sai\\Documents\\semesters\\Sem - 8\\NLP\\PostMidSem\\API\\Images\\Right_hand.jpg"
    image1_path = "C:\\Users\\charan sai\\Documents\\semesters\\Sem - 8\\NLP\\PostMidSem\\API\\Images\\left_hand.jpg"
...
def generate_video(S):
    ...
    video_name = "C:\\Users\\charan sai\\Documents\\semesters\\Sem - 8\\NLP\\PostMidSem\\API\\static\\Video.mp4"
    images = fetch_img(S)
    # print(images)
...
#   img = cv2.imread(image_path)
  ...
  cv2.imwrite("C:\\Users\\charan sai\\Documents\\semesters\\Sem - 8\\NLP\\PostMidSem\\API\\Images\\temp_sign.png", img)
  if compare_images() == 1:
        return " "
  gray_img = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
...
def capture():
    ...
    filename = 'image.jpg'
    cv2.imwrite("C:\\Users\\charan sai\\Documents\\semesters\\Sem - 8\\NLP\\PostMidSem\\API\\static\\"+filename, image)
